...
def generate_launch_description():
        ...
        start_cartesian = ExecuteProcess(
            cmd=['ros2', 'launch', 'robot_cartesian', 'robot_cartesian.launch.py'],
            name='robot_cartesian_launch',
            output='screen',
        )
        ...
        close_evt2 = RegisterEventHandler(
            event_handler=OnProcessStart(
                ...
                on_start=[TimerAction(period=1.0, actions=[start_cartesian, log_moveit_started])],
            )
        )
